...
def encode_source(source):
    """
    TODO: Implement the function to encode the 'Source' feature.

    Instructions:
    - If the value is missing (NaN), return 'Unknown'.
    - Convert the input to a string.
    - If the string is 'Source1', return 1.
    - If the string is 'Source2', return 2.
    - If the string is 'Source3', return 3.
    - For all other values, return 0.

    Example:
        encode_source('Source1')  -> 1
        encode_source('Source2')  -> 2
        encode_source('Source3')  -> 3
        encode_source('Other')    -> 0
        encode_source(None)       -> 'Unknown'
    """
    pass  # TODO: Implement this function